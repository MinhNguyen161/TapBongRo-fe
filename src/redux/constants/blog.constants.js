...
export const UPVOTE_REQUEST = "BLOG.UPVOTE_REQUEST";
export const UPVOTE_SUCCESS = "BLOG.UPVOTE_SUCCESS";
export const UPVOTE_FAILURE = "BLOG.UPVOTE_FAILURE";


export const DOWNVOTE_REQUEST = "BLOG.DOWNVOTE_REQUEST";
export const DOWNVOTE_SUCCESS = "BLOG.DOWNVOTE_SUCCESS";
export const DOWNVOTE_FAILURE = "BLOG.DOWNVOTE_FAILURE";