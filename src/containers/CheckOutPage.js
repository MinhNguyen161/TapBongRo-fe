    ...
    const Product = ({ product, index }) => {
        return (
            <tr>
                <th scope="row" className="border-0">
                    <div className="p-2">
                        ...
                        <div className="ml-3 d-inline-block align-middle">
                            <h5 className="mb-0"> <a href="#" className="text-dark d-inline-block align-middle">{product.itemId.name}</a></h5><span className="text-muted font-weight-normal font-italic d-block">Category: {product.itemId.clothing_type}</span>
                        </div>
                    </div>
                </th>
                ...
                <td className="border-0 align-middle"><strong><img src="./images/heart.png" alt="logo" className="logo_user" /></strong></td>
                <td className="border-0 align-middle"><Button onClick={() => removeItem(product, index)}><img src="./images/bin.png" alt="logo" className="logo_user" /></Button></td>
            </tr>
        )
    }
                        ...
                        <div className="p-4">
                            ...
                            <ul className="list-unstyled mb-4">
                                ...
                                <li className="d-flex justify-content-between py-3 border-bottom"><strong className="text-muted">Total</strong>
                                    <h5 className="font-weight-bold">${parseInt((total + 10) * 100) / 100}</h5>
                                </li>
